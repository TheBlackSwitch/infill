...
var Editor = class {
  ...
  constructor(parent_element, width = "100%", height = "60vh", options = {}) {
    ...
    this.#gen_btn(block_1, () => {
    }, "H1", "Heading 1 | CTRL + H", "infill-align-right");
    this.#gen_btn(block_1, () => {
    }, "H2", "Heading 2", "infill-align-right");
    this.#gen_btn(block_1, () => {
    }, "H3", "Heading 3");
    this.#gen_btn(block_1, () => {
    }, '<i class="infill-icon infill-icon-blockquote"></i>', "Blockquote | CTRL Q");
    this.#gen_btn(block_1, () => {
    }, '<i class="infill-icon infill-icon-codeblock"></i>', "Codeblock");
    this.#gen_btn(block_1, () => {
    }, '<i class="infill-icon infill-icon-code"></i>', "Code | CTRL T");
    let block_2 = document.createElement("div");
    block_2.classList.add("infill-editor-nav-block");
    this.#nav.appendChild(block_2);
    this.#gen_btn(block_2, () => {
    }, "<strong>B</strong>", "Bold Text | CTRL B");
    this.#gen_btn(block_2, () => {
    }, "<em>I</em>", "Italic Text | CTRL I");
    this.#gen_btn(block_2, () => {
    }, "<s>S</s>", "Strikethrough Text | CTRL S");
    this.#gen_btn(block_2, () => {
    }, "<u>U</u>", "Underline Text | CTRL U");
    this.#gen_btn(block_2, () => {
    }, "<mark>H</mark>", "Highlighted Text | CTRL H");
    this.#gen_btn(block_2, () => {
    }, '<i class="infill-icon infill-icon-coloured"></i>', "Colored Text");
    let block_3 = document.createElement("div");
    block_3.classList.add("infill-editor-nav-block");
    this.#nav.appendChild(block_3);
    this.#gen_btn(block_3, () => {
    }, '<i class="infill-icon infill-icon-unordered-list"></i>', "Unordered list | CTRL L");
    this.#gen_btn(block_3, () => {
    }, '<i class="infill-icon infill-icon-ordered-list"></i>', "Ordered list | CTRL O");
    this.#gen_btn(block_3, () => {
    }, '<i class="infill-icon infill-icon-link"></i>', "Refrence Link | CTRL R");
    this.#gen_btn(block_3, () => {
    }, '<i class="infill-icon infill-icon-image"></i>', "Image | CTRL M");
